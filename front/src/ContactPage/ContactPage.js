                            ...
                            <div className="mainpage-content-wrapper">
                                <div className="mainpage-content">
                                    <div className="mainpage-text-block">
                                        <h2 className="mainpage-content-heading">Связь с нами</h2>
                                        <p className="mainpage-info-paragraph">
                                            <p>При возникновении тех, или иных вопросов вы можете связаться с руководством даного ресурса. Контактные данные прилагаются</p><br></br>
                                            <p>+380XX-XX-XX-XXX, +380XX-XX-XX-XXX, +380XX-XX-XX-XXX</p>
                                            <p>email: samplemail@mail.XX, samplemail2@mail.XX</p><br></br>
                                        </p>
                                    </div>
                                </div>
                            </div>
...
let ConnectedContactPage = connect(mapStateToProps)(ContactPage);
