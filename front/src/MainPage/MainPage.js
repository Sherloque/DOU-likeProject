...
import './MainPage.css';
import logo from './logos/csd_emblem updated.jpg'
                        ...
                        <div className="mainpage-main-box">
                            ...
                            <div className="mainpage-content-wrapper">
                                <div className="mainpage-content">
                                    <div className="mainpage-logo-block">
                                        <img src={logo} className="mainpage-logo"></img>
                                    </div>
                                    <div className="mainpage-text-block">
                                        <h2 className="mainpage-content-heading">Добро пожаловать!</h2>
                                        <p className="mainpage-info-paragraph"> Данный сервис предназначен для помощи в трудоустройстве студентов Факультета Компьютерных Наук Харьковского Национального Университета имени В.Н. Каразина.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
