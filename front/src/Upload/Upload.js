...
import { addPhoto } from '../store/action.js'
import './Upload.css'
    ...
    constructor(props) {
      ...
      sendRequest(file) {
        return new Promise((resolve, reject) => {
         ...
         this.props.onAddPhoto(formData)
         /*req.open("POST", "/addphoto");
   ...
   render() {
    return (
      <div className="Upload">
        <h5 className="Title">Загрузить изображение</h5>
...
let ConnectedUpload = connect(null, mapDispatchToProps)(Upload);
